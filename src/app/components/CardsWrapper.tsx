...
export default function CardsWrapper({
  ...
  return (
    <div className="flex flex-row justify-around w-full sm:py-2 z-50 backdrop-blur-sm bottom-5 self-center fixed container h-[150px] sm:h-[200px] md:gap-5 gap-2">
      <button
