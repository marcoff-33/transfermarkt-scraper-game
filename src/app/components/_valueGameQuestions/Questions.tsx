...
import { QuestionType, Solution } from "../games/ValueGame";
...
export default function AgeQuestion({
  ...
  const textAnimations = !textState
    ...
    : "";
  // this component is an overlay to the carousel that the relative questions for the 2 rendered active players
  return (
