  ...
  return (
    <div className="w-[400px] h-[200px] flex">
      <div className="relative grow group">
        {playerData?.scrapedPlayerData.playerHeroImg !== "" && playerData && (
          <Image
            src={playerData.scrapedPlayerData.playerHeroImg}
            alt={"player picture"}
            fill
            className={`absolute object-cover rounded-2xl border-primary transition-all duration-1000 contrast-100 border-[2px] saturate-50  ${
              show
